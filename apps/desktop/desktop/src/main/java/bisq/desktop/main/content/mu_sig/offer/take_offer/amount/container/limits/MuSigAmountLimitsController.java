...
package bisq.desktop.main.content.mu_sig.offer.take_offer.amount.container.limits;
...
public class MuSigAmountLimitsController implements Controller {
    ...
    public void onActivate() {
        pins.add(takeOfferDraftWorkflow.inputAmountLimitsObservable().addObserver(inputAmountLimits -> {
            UIThread.run(() -> {
